declare interface API {
  ...
  onSshClose: (
    callback: (event: { connectionId: string; shellId: string }) => void,
  ) => () => void;
  ...
  // 窗口状态变化监听
  onWindowStateChange: (
    callback: (data: { isFocused: boolean }) => void,
  ) => () => void;
