...
import LoadingFallback from "../shared/ui/LoadingFallback.jsx";
import {
  SettingsSkeleton,
  SidebarLazySkeleton,
} from "../shared/ui/SkeletonLoader.jsx";
...
export const ResourceMonitorWithSuspense = createLazySidebarComponent(
  () => import("../features/monitoring/ResourceMonitor.jsx"),
...
export const IPAddressQueryWithSuspense = createLazySidebarComponent(
  () => import("../features/monitoring/IPAddressQuery.jsx"),
...
export const CommandHistoryWithSuspense = createLazySidebarComponent(
  () => import("../features/terminal/CommandHistory.jsx"),
...
export const ShortcutCommandsWithSuspense = createLazySidebarComponent(
  () => import("../features/terminal/ShortcutCommands.jsx"),
...
export const LocalTerminalSidebarWithSuspense = createLazySidebarComponent(
  () => import("../features/terminal/LocalTerminalSidebar.jsx"),
...
export const WebTerminalWithSuspense = createLazyComponent(
  () => import("../features/terminal/WebTerminal.jsx"),
...
export const ConnectionManagerWithSuspense = createLazySidebarComponent(
  () => import("../features/connections/ConnectionManager.jsx"),
...
export const FileManagerWithSuspense = createLazySidebarComponent(
  () => import("../features/file-manager/index.jsx"),
...
export const SecurityToolsWithSuspense = createLazySidebarComponent(
  () => import("../features/security/SecurityTools.jsx"),
...
export const PortForwardingDialogWithSuspense = createLazySidebarComponent(
  () => import("../features/connections/PortForwardingDialog.jsx"),
...
export const AIChatWindowWithSuspense = createLazyComponent(
  () => import("../features/ai/AIChatWindow.jsx"),
...
const preloadComponents = {
  connectionManager: () =>
    import("../features/connections/ConnectionManager.jsx"),
  fileManager: () => import("../features/file-manager/index.jsx"),
  resourceMonitor: () => import("../features/monitoring/ResourceMonitor.jsx"),
  ipAddressQuery: () => import("../features/monitoring/IPAddressQuery.jsx"),
  securityTools: () => import("../features/security/SecurityTools.jsx"),
  portForwarding: () =>
    import("../features/connections/PortForwardingDialog.jsx"),
  settings: () => import("../features/settings/Settings.jsx"),
  commandHistory: () => import("../features/terminal/CommandHistory.jsx"),
  shortcutCommands: () => import("../features/terminal/ShortcutCommands.jsx"),
  localTerminalSidebar: () =>
    import("../features/terminal/LocalTerminalSidebar.jsx"),
  aiChatWindow: () => import("../features/ai/AIChatWindow.jsx"),
  aboutDialog: () => import("../features/about/AboutDialog.jsx"),
};
