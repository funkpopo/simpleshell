...
const IPC_CHANNEL_DEFINITIONS = Object.freeze([
  ...
  defineRequest(
    "APP_REBUILD_SYSTEM_MENU",
    "app:rebuildSystemMenu",
    "app",
    NO_ARGS_SCHEMA,
  ),
  defineRequest(
  ...
  defineRequest(
    "LATENCY_GET_ALL_INFO",
    "latency:getAllInfo",
    "latency",
    NO_ARGS_SCHEMA,
  ),
  defineRequest(
    "LATENCY_GET_SERVICE_STATUS",
    "latency:getServiceStatus",
    "latency",
    NO_ARGS_SCHEMA,
  ),
  defineRequest(
  ...
  defineRequest(
    "LOCAL_TERMINALS_DETECT",
    "detectLocalTerminals",
    "local-terminal",
    args([optionalObjectArg()], { minItems: 0 }),
  ),
  defineRequest(
  ...
  defineRequest(
    "LOCAL_TERMINAL_GET_INFO",
    "getLocalTerminalInfo",
    "local-terminal",
    args([{}]),
  ),
  defineRequest(
    "LOCAL_TERMINAL_ADD_CUSTOM",
    "addCustomTerminal",
    "local-terminal",
    args([objectArg()]),
  ),
  defineRequest(
    "LOCAL_TERMINAL_UPDATE_CUSTOM",
    "updateCustomTerminal",
    "local-terminal",
    args([{}, objectArg()]),
  ),
  defineRequest(
    "LOCAL_TERMINAL_DELETE_CUSTOM",
    "deleteCustomTerminal",
    "local-terminal",
    args([{}]),
  ),
  defineRequest(
    "LOCAL_TERMINAL_GET_CUSTOM",
    "getCustomTerminals",
    "local-terminal",
    NO_ARGS_SCHEMA,
  ),
  defineRequest(
    "LOCAL_TERMINAL_GET_ALL_ACTIVE",
  ...
  defineRequest(
    "CONNECTION_GET_TAB_STATUS",
    "connection:getTabStatus",
    "connection",
    args([{}]),
  ),
  defineEvent(
  ...
  defineRequest(
    ...
    "listFiles",
    "file",
    args([{}, stringArg(), optionalObjectArg(), stringArg()], {
      minItems: 2,
      maxItems: 4,
    }),
    STANDARD_RESPONSE_SCHEMA,
  ...
  defineRequest(
    ...
    "downloadFile",
    "file",
    args([{}, stringArg(), numberArg()], { minItems: 2, maxItems: 3 }),
    STANDARD_RESPONSE_SCHEMA,
    { permission: "filesystem" },
  ),
  defineRequest(
  ...
  defineRequest(
    "FILE_START_DIRECTORY_WATCH",
    "startDirectoryWatch",
    "file",
    args([{}, stringArg(), optionalObjectArg()], { minItems: 2, maxItems: 3 }),
    STANDARD_RESPONSE_SCHEMA,
    { permission: "filesystem" },
  ),
  defineRequest(
    "FILE_STOP_DIRECTORY_WATCH",
    "stopDirectoryWatch",
    "file",
    args([{}, {}]),
    STANDARD_RESPONSE_SCHEMA,
  ...
  defineRequest(
    ...
    "uploadDroppedFiles",
    "file",
    args([{}, stringArg(), objectArg(), stringArg()]),
    STANDARD_RESPONSE_SCHEMA,
    { permission: "filesystem" },
  ),
  defineRequest(
  ...
  defineRequest(
    "FILE_VALIDATE_DROPPED_ITEMS",
    "validateDroppedItems",
    "file",
    args([arrayArg()]),
    STANDARD_RESPONSE_SCHEMA,
    { permission: "filesystem" },
  ...
  defineRequest(
    "FILE_CHECK_DROPPED_UPLOAD_CONFLICTS",
  ...
  defineEvent(
    "TRANSFER_PROGRESS_BATCH",
    "transfer-progress:batch",
    "file",
    args([arrayArg()]),
  ),
  defineEvent(
    "DYNAMIC_UPLOAD_PROGRESS",
    "upload-progress-*",
    "file",
    args([objectArg()]),
    { dynamic: true },
  ...
  defineEvent(
    "DYNAMIC_UPLOAD_FOLDER_PROGRESS",
  ...
  defineEvent(
    "DYNAMIC_UPLOAD_DROPPED_PROGRESS",
    "upload-dropped-progress-*",
    "file",
    args([objectArg()]),
    { dynamic: true },
  ),
  ...
  defineRequest(
    "SFTP_CREATE_FILE_SNAPSHOT",
    "createFileSnapshot",
    "sftp",
    args([{}, stringArg(), stringArg(), optionalObjectArg()], {
      minItems: 3,
      maxItems: 4,
    }),
    STANDARD_RESPONSE_SCHEMA,
  ...
  defineRequest(
    "SFTP_RESTORE_FILE_SNAPSHOT",
    "restoreFileSnapshot",
    "sftp",
    args([{}, stringArg(), stringArg(), {}], { minItems: 3, maxItems: 4 }),
    STANDARD_RESPONSE_SCHEMA,
    { permission: "filesystem" },
  ),
  defineEvent(
    "EXTERNAL_EDITOR_SYNC",
  ...
  defineRequest(
    "SETTINGS_SAVE_LOG",
    "settings:saveLogSettings",
    "settings",
    args([objectArg()]),
  ),
  defineRequest(
    "SETTINGS_GET_ERROR_REPORTING",
    "settings:getErrorReportingSettings",
    "settings",
    NO_ARGS_SCHEMA,
  ),
  defineRequest(
    "SETTINGS_SAVE_ERROR_REPORTING",
    "settings:saveErrorReportingSettings",
    "settings",
    args([objectArg()]),
  ),
  defineRequest(
    "SETTINGS_UPDATE_PREFETCH",
    "settings:updatePrefetchSettings",
    "settings",
    args([objectArg()]),
  ),
  defineRequest(
    "SETTINGS_GET_CREDENTIAL_SECURITY_STATUS",
    "settings:getCredentialSecurityStatus",
    "settings",
    NO_ARGS_SCHEMA,
  ),
  defineRequest(
    "SETTINGS_UPDATE_CREDENTIAL_SECURITY",
    "settings:updateCredentialSecurity",
    "settings",
    args([objectArg()]),
    STANDARD_RESPONSE_SCHEMA,
    { permission: "credentials" },
  ...
  defineRequest(
    "SETTINGS_UNLOCK_CREDENTIAL_STORE",
    "settings:unlockCredentialStore",
    "settings",
    args([stringArg()]),
    STANDARD_RESPONSE_SCHEMA,
    { permission: "credentials" },
  ...
  defineRequest(
    "SETTINGS_LOCK_CREDENTIAL_STORE",
    "settings:lockCredentialStore",
    "settings",
    NO_ARGS_SCHEMA,
    STANDARD_RESPONSE_SCHEMA,
    { permission: "credentials" },
  ...
  defineEvent(
    "SETTINGS_LOCAL_DATA_CLEARED",
    "settings:localDataCleared",
    "settings",
    args([objectArg()]),
  ),
  defineRequest(
    "CONFIG_TRANSFER_EXPORT",
    "settings:configTransferExport",
    "settings",
    args([objectArg()]),
    STANDARD_RESPONSE_SCHEMA,
    { permission: "filesystem" },
  ...
  defineRequest(
    "CONFIG_TRANSFER_IMPORT",
    "settings:configTransferImport",
    "settings",
    args([objectArg()]),
    STANDARD_RESPONSE_SCHEMA,
    { permission: "filesystem" },
  ...
  defineRequest(
    "CONFIG_TRANSFER_LIST_SECTIONS",
    "settings:configTransferListSections",
    "settings",
    NO_ARGS_SCHEMA,
  ),
  defineRequest(
    "CONFIG_SYNC_LOAD_SETTINGS",
    "settings:configSyncLoadSettings",
    "settings",
    NO_ARGS_SCHEMA,
  ),
  defineRequest(
    "CONFIG_SYNC_SAVE_SETTINGS",
    "settings:configSyncSaveSettings",
    "settings",
    args([objectArg()]),
  ),
  defineRequest(
    "CONFIG_SYNC_TEST",
    "settings:configSyncTest",
    "settings",
    args([objectArg()]),
    STANDARD_RESPONSE_SCHEMA,
    { permission: "network" },
  ...
  defineRequest(
    "CONFIG_SYNC_DOWNLOAD",
    "settings:configSyncDownload",
    "settings",
    args([objectArg()]),
    STANDARD_RESPONSE_SCHEMA,
    { permission: "network" },
  ...
  defineEvent(
    "CONFIG_TRANSFER_IMPORTED",
    "settings:configTransferImported",
    "settings",
    args([objectArg()]),
  ),
  defineRequest(
    "CONFIG_SYNC_GET_STATUS",
    "settings:configSyncGetStatus",
    "settings",
    NO_ARGS_SCHEMA,
  ),
  defineRequest(
    "CONFIG_SYNC_PULL_NOW",
    "settings:configSyncPullNow",
    "settings",
    NO_ARGS_SCHEMA,
    STANDARD_RESPONSE_SCHEMA,
    { permission: "network" },
  ...
  defineRequest(
    "SHORTCUT_COMMANDS_GET",
    "get-shortcut-commands",
    "settings",
    NO_ARGS_SCHEMA,
  ),
  defineRequest(
    "SHORTCUT_COMMANDS_SAVE",
  ...
  defineRequest(
    "COMMAND_HISTORY_GET_SUGGESTIONS",
    "command-history:getSuggestions",
    "settings",
    args([stringArg(), numberArg()], { minItems: 1, maxItems: 2 }),
  ),
  defineRequest(
    "COMMAND_HISTORY_INCREMENT_USAGE",
    "command-history:incrementUsage",
    "settings",
    args([stringArg()]),
  ),
  defineRequest(
  ...
  defineRequest(
    "COMMAND_HISTORY_GET_STATISTICS",
    "command-history:getStatistics",
    "settings",
    NO_ARGS_SCHEMA,
  ),
  defineRequest(
    "COMMAND_HISTORY_GET_ALL",
    "command-history:getAll",
    "settings",
    NO_ARGS_SCHEMA,
  ),
  defineRequest(
  ...
  defineRequest(
    "COMMAND_HISTORY_DELETE_BATCH",
    "command-history:deleteBatch",
    "settings",
    args([arrayArg()]),
  ),
  defineEvent(
  ...
  defineRequest(
    "PROXY_SAVE_DEFAULT_CONFIG",
    "proxy:saveDefaultConfig",
    "proxy",
    args([objectArg()]),
  ),
  defineRequest(
    "PROXY_GET_SYSTEM_CONFIG",
  ...
  defineRequest(
    "MEMORY_GET_DIAGNOSTICS",
    "memory:getDiagnostics",
    "memory",
    NO_ARGS_SCHEMA,
  ),

  defineRequest(
    "RUNTIME_FILES_CONFIGURE",
    "runtime-files:configure",
    "runtime-files",
    args([stringArg(), objectArg()], { minItems: 1, maxItems: 2 }),
    STANDARD_RESPONSE_SCHEMA,
    { permission: "filesystem" },
  ),
  defineRequest(
    "RUNTIME_FILES_RELEASE_PATH",
    "runtime-files:releasePath",
    "runtime-files",
    args([stringArg(), stringArg(), objectArg()], { minItems: 2, maxItems: 3 }),
    STANDARD_RESPONSE_SCHEMA,
    { permission: "filesystem" },
  ),
  defineRequest(
...
for (const definition of IPC_CHANNEL_DEFINITIONS) {
  ...
  if (
    !definition.dynamic &&
    channelDefinitionsByChannel.has(definition.channel)
  ) {
