 ...
 */
export const createUnifiedTheme = (darkMode) => createTheme({
  palette: {
    ...
    MuiButton: {
      styleOverrides: {
        ...
        outlined: {
          ...
          '&:hover': {
            borderWidth: '1.5px',
            backgroundColor: darkMode ? 'rgba(144, 202, 249, 0.04)' : 'rgba(25, 118, 210, 0.04)',
          },
        },
        text: {
          '&:hover': {
    ...
    MuiListItemButton: {
      styleOverrides: {
        root: {
          ...
          // 选中状态
          '&.Mui-selected': {
            backgroundColor: darkMode ? 'rgba(144, 202, 249, 0.12)' : 'rgba(25, 118, 210, 0.08)',
            // 选中时的悬停效果，避免过度高亮
            '&:hover': {
    ...
    MuiTooltip: {
      styleOverrides: {
        tooltip: {
          borderRadius: 6,
          fontSize: '0.75rem',
          backgroundColor: darkMode ? 'rgba(97, 97, 97, 0.95)' : 'rgba(97, 97, 97, 0.9)',
          boxShadow: '0 2px 8px rgba(0,0,0,0.15)',
        },
      },
    },
