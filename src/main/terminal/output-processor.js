...
const { sanitizeCommandForLog } = require("../utils/log-sanitizer");
const highlightRuleConfigs = require("../../shared/domain/highlight-configs"); // New import
...
const { escapeRegExp: escapeRegex } = require("../utils/textUtils");
