...
const ThinkContent = ({
  ...
  const markdownComponents = {
    ...
    h3: ({ children }) => (
      <Typography
        variant="body2"
        sx={{ fontSize: "0.7rem", fontWeight: "bold", mb: 0.5 }}
      >
        {children}
      </Typography>
    ),
  ...
  return (
    <Paper elevation={0} sx={getContainerStyles()} data-testid="think-content">
      {/* 头部 - 点击区域 */}
      <Box
        sx={{
          display: "flex",
      ...
      >
        ...
        <Tooltip
          title={
            expanded ? t("common.collapse", "折叠") : t("common.expand", "展开")
          }
        >
          <IconButton
            size="small"
