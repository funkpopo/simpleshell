    ...
    >
      {open && (
        <>
          ...
          <Box sx={{ flexGrow: 1, overflow: 'auto', p: 2, height: 'calc(100% - 56px)' }}>
            {loading && !systemInfo ? (
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                      ...
                      <LinearProgress 
                        ...
                        sx={{ 
                          ...
                          '& .MuiLinearProgress-bar': {
                            bgcolor: systemInfo.cpu.usage > 80 
                ...
                >
                  ...
                  <Box sx={{ ml: 4 }}>
                    <Typography variant="body2" gutterBottom>
                      <strong>总内存:</strong> {formatBytes(systemInfo.memory.total)}
                    </Typography>
                    <Typography variant="body2" gutterBottom>
                      <strong>已用内存:</strong> {formatBytes(systemInfo.memory.used)} ({systemInfo.memory.usagePercent}%)
                    </Typography>
                    <Typography variant="body2" gutterBottom>
                      <strong>空闲内存:</strong> {formatBytes(systemInfo.memory.free)}
                    </Typography>
                    ...
                    <Box sx={{ mt: 1, mb: 0.5 }}>
                      <LinearProgress 
                        ...
                        sx={{ 
                          ...
                          bgcolor: theme.palette.mode === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)',
                          '& .MuiLinearProgress-bar': {
                            bgcolor: systemInfo.memory.usagePercent > 80 
                              ? theme.palette.error.main 
